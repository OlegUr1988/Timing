...
if __name__ == '__main__':
    ...
    if EXECUTION_MODE == 'FULL':
        ...
        data_file = f"{currency_pair}_Hourly_Bid_2022.10.07_2025.11.02.csv" # 3 y
        data_file = f"{currency_pair}_Hourly_Bid_2024.10.26_2025.10.26.csv" # 2025
        data_file = f"{currency_pair}_Hourly_Bid_2025.10.26_2025.11.02.csv" # 3 M
        data_file = f"{currency_pair}_Hourly_Bid_2023.10.26_2024.10.26.csv" # 2024
    ...
    # --- Mode 3: Real-Time Forecast ---
        ...
        results_recent = analyze_fibonacci_cycles(df_recent_disc_fractals, 
                                                  recent_disc_indices
                                                  tolerance_window=GRID_MATCH_TOLERANCE)
