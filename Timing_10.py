        ...
        if not results.empty:
            ...
            if not good_cycle_lengths:
                ...
                if not all_forecasts_df.empty:
                    ...
                    # Optional: Save detailed forecasts
                    # all_forecasts_df.to_csv(f"{currency_pair}_all_forecasts.csv", index=False)
                ...
                if not enter_points_df.empty:
                    ...
                    print("Sample of Enter Points DataFrame with Contributing IDs:")
                    print(enter_points_df.head()) 
                    
                    # Optional: Save enter points
                    # enter_points_df.to_csv(f"{currency_pair}_enter_points.csv", index=False)
