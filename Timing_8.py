...
def plot_price_chart_with_enter_points(df_original, enter_points_df, currency_pair):
    ...
    chart_title = f"{currency_pair.upper()} Price Chart with Enter Points (F_Count >= 3)"
        ...
        if not results.empty:
            ...
            if not good_cycle_lengths:
                ...
                if not enter_points_df.empty:
                    ...
                    plot_price_chart_with_enter_points(df, enter_points_df, currency_pair)
                else:
